...
<div class="bg">
  <div class="contain" id="tabs" style="margin:0 auto;">
        <div class="text-nav">
      <ul class="clearfix">
        <li> <a class="text-link" href="<?php echo U('Company/website');?>">网站公告</a> </li>
        <li> <a class="text-link" href="<?php echo U('Company/media');?>">媒体报道</a> </li>
        <li class="selected"> <a class="text-link" href="<?php echo U('Company/introduce');?>">公司简介</a> </li>
        <li> <a class="text-link" href="<?php echo U('Company/manage');?>">管理团队</a> </li>
        <li> <a class="text-link" href="<?php echo U('Company/partner');?>">合作伙伴</a> </li>
        <li> <a class="text-link" href="<?php echo U('Company/styles');?>">团队风采</a> </li>
        <li> <a class="text-link" href="<?php echo U('Company/legalpolicy');?>">法律政策</a> </li>
        <li> <a class="text-link" href="<?php echo U('Company/statement');?>">法律声明</a> </li>
        <li> <a class="text-link" href="<?php echo U('Company/postage');?>">资费说明</a> </li>
        <li> <a class="text-link" href="<?php echo U('Company/personnel');?>">招贤纳士</a> </li>
        <li> <a class="text-link" href="<?php echo U('Company/contact');?>">联系我们</a> </li>
      </ul>
    </div>
    <div class="text-box">
