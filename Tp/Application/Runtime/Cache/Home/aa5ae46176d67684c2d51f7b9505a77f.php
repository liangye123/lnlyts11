  ...
  <div class="w1200 personal">
    <div class="credit-ad"><img src="images/clist1.jpg" width="1200" height="96"></div>
      ...
      <ul>
        ...
        <li class=""><span><a href="<?php echo U('My/openthird');?>"><i class="dot dot02"></i>开通第三方</a> </span> </li>
        <li><span><a href="<?php echo U('My/recharge');?>"><i class="dot dot03"></i>充值</a></span></li>
        <li class=""><span><a href="<?php echo U('My/withdrawals');?>"><i class="dot dot04"></i>提现</a></span></li>
        <li style="position:relative;" class=""> <span> <a href="<?php echo U('My/redbag');?>"> <i class="dot dot06"></i> 我的红包 </a> </span> </li>
        <li class=""><span><a style="font-size:14px;text-align:center;width:115px;padding-right:35px;" href="<?php echo U('My/exchange');?>">兑换历史</a></span></li>
        <li style="position:relative;"> <span> <a href="<?php echo U('My/system');?>"><i class="dot dot08"></i>系统信息 </a> </span> </li>
        <li><span><a href="<?php echo U('My/account');?>"><i class="dot dot09"></i>账户设置</a></span></li>
      </ul>
    </div>
