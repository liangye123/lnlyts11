...
<head>
    ...
    <link rel="stylesheet" href="css/passport_wdg_8b183f3_1.css"/>
    <link rel="stylesheet" href="css/index_e7cd5c0_1.css"/>
</head>
        ...
        <div class="car-center">
            ...
            <span class="j-checkbox j-checked">
                 <input name="rememberme" id="rememberme" type="checkbox" checked="checked"/>
                                ...
                                <label for="rememberme"><span class="agree">我已经阅读并同意<a
                                        href="/pc/agreement/contract/currency/name/user.we_reg" target="_blank">《we.com平台注册服务协议》</a>和<br/><a
                                        href="/pc/agreement/contract/currency/name/user.rrd_reg" target="_blank">《renrendai.com平台注册服务协议》</a></span></label>
                ...
                <div id="form-reg">
                    <div class="reg-form">
                        <ul class="reg-ul">
                            <li>
                                <input class="ui-input" type="text" placeholder="请输入手机号" maxlength="48" name="username"
                                       id="reg_username"/>
                            </li>
                            ...
                            <li>
                                <input class="ui-input " id="reg_password" autocomplete="off"
                                       placeholder="密码为8~16位数字、字母或符号组合" type="password" name='password'/>
        ...
        <span class="j-checkbox j-checked">
             <input name="rememberme" id="rememberme" type="checkbox" checked="checked"/>
                        ...
                        <div class="reg-submit">
                            <input type="submit" class="reg-btn" value='注册领红包'/>
                            <img src="picture/loading_dbf3776_1.gif"/>
                        </div>
                        <div class="reg-error">
                            请输入正确的手机号
